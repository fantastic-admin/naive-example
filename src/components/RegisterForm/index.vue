  ...
  <NForm ref="formRef" :model="form" :rules="rules" :show-label="false" class="min-h-500px w-full flex-col-stretch-center p-12">
    ...
    <div>
      ...
      <NFormItem path="password">
        <NInput v-model:value="form.password" type="password" show-password-on="click" size="large" placeholder="密码" tabindex="3">
          <template #prefix>
      ...
      <NFormItem path="checkPassword">
        <NInput v-model:value="form.checkPassword" type="password" show-password-on="click" size="large" placeholder="确认密码" tabindex="4">
          <template #prefix>
            <SvgIcon name="ri:lock-2-fill" />
          </template>
        </NInput>
